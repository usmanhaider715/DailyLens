...
router.get('/evergreen/run-status/:jobId', evergreen.getEvergreenRunStatus);
router.post('/evergreen/run-status/:jobId/control', evergreen.postEvergreenRunControl);
router.get('/evergreen/active-job', evergreen.getEvergreenActiveJob);
