        ...
        <div className="grid grid-cols-2 gap-8 text-sm">
          <div>
            ...
            <ul className="mt-2 space-y-1 text-gray-600 dark:text-gray-300">
              <li>
                <Link to="/category/World" className="hover:text-primary-700">
                  World
                </Link>
              </li>
              <li>
                <Link to="/category/Technology" className="hover:text-primary-700">
                  Technology
                </Link>
              </li>
              <li>
                <Link to="/category/Business" className="hover:text-primary-700">
                  Business
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="mt-2 space-y-1 text-gray-600 dark:text-gray-300">
              ...
              <li>
                <Link to="/admin/login" className="hover:text-primary-700">
                  Admin
                </Link>
              </li>
              <li>
